...
from admin_dashboard.models import EVChargingLocation
# from .revin.admin_dashboard.models import EVChargingLocation


# No module named 'admin_dashboard.management.commands.revin'

class Command(BaseCommand):
    help = 'Load data from EV Station file'

    def handle(self, *args, **kwargs):
        data_file = "/Users/amanrahamanbiswas/revin/EV_Charging_Stations.csv"
